...
# Approach 1: Geographic Analysis

## Western vs Non-Western States
...
## Geographic Differences-in-Differences
...
# Create k-means based analysis using the analysis variable
lbank_kmeans <- lbank %>%
...
## K-Means Differences-in-Differences
...
## Optimal Matching Two-Line Analysis
...
## Optimal Matching Differences-in-Differences
...
## Optimal Matching Regression Results
...
Compare the three approaches to see which provides the most convincing causal identification and largest treatment effects.