...
date_formula <- as.formula(paste("`", analysis_variable, "` ~ crash + Date", sep=""))
full_formula <- as.formula(paste("`", analysis_variable, "` ~ crash + State + Date", sep=""))
...
model3 <- lm_robust(date_formula, data = lbank, se_type = "HC1")
...
lbank_reg_kmeans$Date <- as.factor(lbank_reg_kmeans$Date)
...
date_formula_kmeans <- as.formula(paste("`", analysis_variable, "` ~ kmeans_crash + Date", sep=""))
full_formula_kmeans <- as.formula(paste("`", analysis_variable, "` ~ kmeans_crash + State + Date", sep=""))
...
model3_kmeans <- lm_robust(date_formula_kmeans, data = lbank_reg_kmeans, se_type = "HC1")
